...
Source0  : https://files.pythonhosted.org/packages/db/38/2992ff192eaa7dd5a793f8b6570d6bbe887c4fbbf7e72702eb0a693a01c8/colorlog-6.8.2.tar.gz
...
%prep
%setup -q -n colorlog-6.8.2
cd %{_builddir}/colorlog-6.8.2
pushd ..
cp -a colorlog-6.8.2 buildavx2
popd
pushd ..
cp -a colorlog-6.8.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707114445
