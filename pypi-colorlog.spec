...
Source0  : https://files.pythonhosted.org/packages/d3/7a/359f4d5df2353f26172b3cc39ea32daa39af8de522205f512f458923e677/colorlog-6.9.0.tar.gz
...
%prep
%setup -q -n colorlog-6.9.0
cd %{_builddir}/colorlog-6.9.0
pushd ..
cp -a colorlog-6.9.0 buildavx2
popd
pushd ..
cp -a colorlog-6.9.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730293624
